          ...
          children: [
            ...
            const Padding(
              ...
              child: SizedBox(
                width: 300,
                child: Text(
                  'Disclaimer & Fair Use\n\nThis is a community driven fan made, non-commercial supplement of Warmachine. The intention of this project is to promote Warmachine by offering an alternative to Mark 4. Warmachine is owned by Steam Forge Games, please support Steamforged Games and Warmachine by also supporting the official release.\n\nThe Mark 3.5 Commission is not affiliated, associated, authorized, endorsed by, or in any way officially connected with Steamforged Games. Mark 3.5 was created in a personal capacity, the contents expressed are the Mark 3.5 Commissions own and do not reflect the view of Steam Forge Games or any of its affiliates.\n\nThe Mark 3.5 Commission does not claim nor implies any ownership rights to Warmachine, or any of Steamforged Games\'copyrights or trademarks. Furthermore, any content found in Mark 3.5 is for not-for-profit use only under Fair use exception in US Law.',
                  textAlign: TextAlign.center,
