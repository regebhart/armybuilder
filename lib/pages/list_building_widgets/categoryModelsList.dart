  ...
  Widget build(BuildContext context) {
    ...
    for (int g = 0; g < groups.length; g++) {
      ...
      for (int index = 0; index < faction.filteredProducts[g].length; index++) {
        bool add = true;
        // if (army.selectedcasterFactionIndexes.isNotEmpty && faction.selectedCategory == 1) {
        //   if (!faction.filteredProducts[g][index].primaryFaction.contains(AppData().factionList[army.selectedcasterFactionIndexes]['name'])) {
        //     add = false;
        //   }
        // }
